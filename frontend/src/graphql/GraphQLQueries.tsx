...
export const ADD_MOVIE = gql`
  mutation RootMutationType($title: String!, $type: String!, $episodes: Int!, $description: String!) {
    addMovie($title: String!, $type: String!, $episodes: Int!, $description: String!title: $title)
  }
`
